...
// Login Registration system Homepage
...
//Register
// 1. Give user a form to register
router.get('/register', async (req, res, next) => {
  res.render('registerForm');
});

/* 2. Handle a POST request on `/users/register` where we will capture the data & save it into mongoDB database ------*/
...
router.get('/dashboard/logout', async (req, res, next) => {
  req.session.destroy();
